      ...
      <div className="max-w-3xl mx-auto px-6 py-24">
        <div className="mb-12">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            ...
            Confluence, Notion, dozens of code repositories, and Terraform modules. Here is how I built a knowledge-base MCP that
